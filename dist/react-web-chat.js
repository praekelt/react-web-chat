(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-dom'), require('react-redux'), require('lodash'), require('react/jsx-runtime'), require('react-linkify'), require('react-markdown'), require('rwc-feersum-client'), require('redux')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-dom', 'react-redux', 'lodash', 'react/jsx-runtime', 'react-linkify', 'react-markdown', 'rwc-feersum-client', 'redux'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactWebChat = {}, global.React, global.ReactDOM, global.ReactRedux, global._, global.jsxRuntime, global.Linkify, global.ReactMarkdown, global.FeersumClient, global.Redux));
})(this, (function (exports, React, ReactDOM, reactRedux, lodash, jsxRuntime, Linkify, ReactMarkdown, feersumClient, redux) { 'use strict';

    const DefaultText = ({
      children
    }) => jsxRuntime.jsx(Linkify, {
      children: jsxRuntime.jsx(ReactMarkdown, {
        children: children
      })
    });
    const Message = ({
      ...
      return jsxRuntime.jsx("div", {
        ...
        children: jsxRuntime.jsx(TextComponent, {
          children: text
        })
      });
    };
    ...
    const MessageList = ({
      ...
      return jsxRuntime.jsx("div", {
        ...
        children: messages.map((message, index) => jsxRuntime.jsx(Message, {
          ...message,
          theme: theme
        }, index))
      });
    };
    var MessageList$1 = reactRedux.connect(mapStateToProps$1)(MessageList);
    ...
    const InputArea = ({
      ...
      const DefaultInput = () => jsxRuntime.jsx("input", {
        type: "text",
        value: value,
    ...
    var InputArea$1 = reactRedux.connect()(InputArea);
    ...
    const ChatContainer = ({
      ...
      return jsxRuntime.jsxs("div", {
        ...
        children: [jsxRuntime.jsx(MessageList$1, {
          theme: theme
        }), jsxRuntime.jsx(InputArea$1, {
          ...theme
        })]
      });
    };
    var ChatContainer$1 = reactRedux.connect(mapStateToProps)(ChatContainer);
    ...
    // @ts-check
    const composeEnhancers = typeof window === 'object' && window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ || redux.compose;
    const createStoreWithState = (initialState = {}) => redux.createStore(reducers, initialState, composeEnhancers(redux.applyMiddleware(thunk, eventEmitterMiddleware)));
    ...
    const createStore = ({
      ...
      config: lodash.merge({}, defaultConfig, {
        typingStatus
      }, {
        network
      }, {
    ...
    class ReactWebChatComponent extends React.Component {
      constructor(props) {
        super(props);
        const {
          avatar,
    ...
    exports.ReactWebChat = ReactWebChat;
    exports.ReactWebChatComponent = ReactWebChatComponent;
